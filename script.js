...
function aiStrategy(){
  ...
  if (aiSelfEnergy === 0 && aiOpponentEnergy === 0 && validMovesForAISelf.includes(MOVE_CHARGE)) { // 溜めは常に有効
    return MOVE_CHARGE;
  }
  if (aiSelfEnergy === 0 && aiOpponentEnergy === 2 && validMovesForAISelf.includes(MOVE_CHARGE)) { // 溜めは常に有効
    return MOVE_CHARGE;
  }
